...
export function InteractiveGlobe() {
    ...
    return (
        <div className='relative w-full h-full'>
            ...
            <div className='fixed sm:absolute bottom-2 right-2 sm:bottom-4 sm:right-4 z-10 bg-white/90 backdrop-blur-sm rounded-lg px-2.5 py-1.5 sm:px-3 sm:py-2 shadow-lg'>
                <p className='text-[10px] sm:text-xs text-gray-600 flex items-center gap-1 whitespace-nowrap'>
                    ...
                    >
                        <RiTwitterXLine className='w-3 h-3 sm:w-3.5 sm:h-3.5' />
                    </a>
                    <a
